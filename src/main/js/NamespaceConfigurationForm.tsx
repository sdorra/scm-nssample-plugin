  ...
  render() {
    ...
    return (
      <form onSubmit={this.submit}>
        ...
        />
        <SubmitButton label={t("scm-nssample-plugin.save")} loading={loading} disabled={!this.isValid()} />
      </form>
    );
  }
}
export default withTranslation("plugins")(NamespaceConfigurationForm);
